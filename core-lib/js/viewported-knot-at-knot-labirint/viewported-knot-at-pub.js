...
function KnotLabirint() {
    ...
    let passThrough = window['@pencil/draft-knot-labirint']['passThrough']
...
function KnotFromCubicProjectFromBottomStatement() {
    let that = this
...
function KnotFromCubicProject() {
    ...
    let passThrough = window['@pencil/draft-at-bounced']['passThrough']
    // keep
