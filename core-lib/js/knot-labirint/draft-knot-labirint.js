...
(function() {
    ...
    const Pencil = window['@pencil/draft-compact-knot-labirint']['Pencil']
    const DraftFabrikk = window['@pencil/draft-compact-knot-labirint']['DraftFabrikk']

    // keep !
    let passThroughFromBottom = {}
    passThroughFromBottom['@pencil/draft-knot-labirint'] = {}
    // keep

    passThrough['@pencil/draft-knot-labirint'] = function (spawnedPointerBelongings) {
...
// keep !
passThroughFromBottom['@pencil/draft-knot-labirint']['FIELD_OF_VIEW'] = FIELD_OF_VIEW
passThroughFromBottom['@pencil/draft-knot-labirint']['PROJECTION_CENTER_Y'] = PROJECTION_CENTER_Y
passThroughFromBottom['@pencil/draft-knot-labirint']['PROJECTION_CENTER_X'] = PROJECTION_CENTER_X

passThroughFromBottom['@pencil/draft-knot-labirint']['canvas'] = ctx
...
spawnedPointerBelongings = draftFabrikk.spawnPointerBelongingsAtRectangle(/* keep */ /* y, x, z */ spawnedPointerBelongings.y, spawnedPointerBelongings.x, debPointer, /* radius, d, f, frontRatio */ radius, 0.9, 0.4, 1, /* keep */ /* debthScaleRatio, frontScaleRatio, profileScaleRatio */ 1 * 4 * 2, 1 * 4, 1 * 2)
// keep !
...
// keep
let knot1 = draftFabrikk.constructKnot(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ 1 * 4, 1 * 4, 1 * 4 * 1.7)
...
// keep
window['@pencil/draft-knot-labirint'] = {
    passThrough: passThrough['@pencil/draft-knot-labirint'],
    passThroughFromBottom: passThroughFromBottom['@pencil/draft-knot-labirint']
}
// keep
